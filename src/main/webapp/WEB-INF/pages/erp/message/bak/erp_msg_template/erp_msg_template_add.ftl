...
<title>    新增</title>
   <#include "../../../../framework/comm/meta.ftl" />
	...
	<script>
		...
		function addErpMsgTemplate(fm,url){
			setHiddenDataByForm();
...
<body class="easyui-layout">
	<div data-options="region:'west',title:'参数配置',split:true,collapsible:false" style="width: 380px;">
		<table id="erp_msg_argument_config_dg" title="参数配置信息" class="easyui-datagrid" url="${basePath}/erpMsgTemplateController/searchErpMsgArgumentConfigList/MSAA"
	...
	<div data-options="region:'center',title:'添加模板'" style="padding:5px; width: 1600px;">
		<div id="dlg">
			<div class="part-toolbar">
				<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true"
				 onclick="addErpMsgTemplate('fm','${basePath}/erpMsgTemplateController/addErpMsgTemplate')">保存</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"  data-options="iconCls:'icon-save',plain:true"
				  onclick="javascript:$('#fm').form('clear')">重置</a>
			</div>
			<form id="fm" method="post">
				<div class="part">
					...
					<p>
						<label>是否启用:</label> 
						<select id="search_select_status" class="easyui-combobox" editable="false" class="easyui-validatebox" required="true">
					...
					<p><label>标题:</label> 
					 ...
					 /></p><br/><br/>
					<p><label>信息头:</label> 
						<input type="text" name="header" style="width:510px;" 
					 /></p><br/><br/>
					<p><label>正文:</label> 
						<!-- 加载编辑器的容器 -->
					...
					<p><label>结尾:</label> 
						<input type="text" name="end"   style="width:510px;"
					 /></p><br/><br/>
					<p>
						<label>备注:</label> 
						<textarea  name="remark" class="textarea-bigtext" style="width:825px;height:100px"></textarea>
					</p>

...
<body
	...
	<div style="margin:10px 0;">
		<a href="#" class="easyui-linkbutton" onclick="javascript:window.parent.savedatarole(getTableItemDate('right_data','dataRoleId'))">保存</a> 
	</div>
  <div style="float: left;">
  <table id="left_data" class="easyui-datagrid" title="待选数据角色"
		style="height: auto; width: 210px;" url="./searchDataList?staffId=${staffId }"
		  rownumbers="false" fitColumns="true"
		singleSelect="true" selectOnCheck="true" checkOnSelect="true">
		<thead>
			<tr>
				<th data-options="field:'dataRoleId',hidden:true">角色主键</th>
	 ...
	 <div style="float: left;">
		  <table id="right_data" class="easyui-datagrid" title="已有数据角色"
		style="height: auto; width: 210px;" url="./searchSelectedDataList?staffId=${staffId}"
		  rownumbers="false" fitColumns="true"
		singleSelect="true" selectOnCheck="true" checkOnSelect="true">
		<thead>
			<tr>

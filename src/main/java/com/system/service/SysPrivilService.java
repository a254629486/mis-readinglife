 ...
 * <b>文件名：</b>SysPrivilService.java<br/>
 * <b>描述：</b>TODO<br/>
 * <b>版本信息：</b>v1.0.0<br/>
 ...
 * 
 */
public interface SysPrivilService extends ISingleBaseService {
	JsonPager selectByPageMap(JsonPager jPager, Map param);
	JsonPager selectButtonByPageMap(JsonPager jPager, Map param);

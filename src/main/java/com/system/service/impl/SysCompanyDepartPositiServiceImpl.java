...
@Service("SysCompanyDepartPositiService")
public class SysCompanyDepartPositiServiceImpl extends BaseService implements
		SysCompanyDepartPositiService {

	public JsonPager selectByPageMap(JsonPager jPager, Map param) {
		return selectByPage(
				"com.system.dao.impl.SysCompanyDepartDAO.positiselectId",
				"com.system.dao.impl.SysCompanyDepartDAO.positicountId",
				jPager, param);
	}
